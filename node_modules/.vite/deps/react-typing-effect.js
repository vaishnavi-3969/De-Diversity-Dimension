  ...
  "node_modules/react-typing-effect/dist/index.js"(exports, module) {
    !function(e, t) {
      ...
      return function(e) {
        ...
        var s = function(e2) {
          ...
          return function(e3, t3) {
            ...
            return "string" == typeof e3 ? [e3] : [].concat(function(e4) {
              if (Array.isArray(e4)) {
                for (var t3 = 0, r2 = Array(e4.length); t3 < e4.length; t3++)
                  r2[t3] = e4[t3];
                return r2;
              }
            ...
            var e3 = this.props, t3 = (e3.speed, e3.eraseSpeed, e3.typingDelay, e3.eraseDelay, e3.staticText), r2 = (e3.text, e3.cursor), n2 = e3.displayTextRenderer, o2 = e3.cursorClassName, i2 = e3.cursorRenderer, c2 = function(e4, t4) {
              var r3 = {};
              for (var n3 in e4)
                t4.indexOf(n3) >= 0 || Object.prototype.hasOwnProperty.call(e4, n3) && (r3[n3] = e4[n3]);
              return r3;
            ...
            return u.default.createElement("span", c2, t3 ? u.default.createElement("span", null, t3, "\xA0") : null, u.default.createElement("div", { style: { display: "inline-block" } }, n2 ? n2(l, f) : l), u.default.createElement(a.default, { cursor: r2, cursorRenderer: i2, className: o2 }));
          } }]), t2;
        }();
        ...
        function m(e2) {
          for (var t2 = "https://reactjs.org/docs/error-decoder.html?invariant=" + e2, r2 = 1; r2 < arguments.length; r2++)
        ...
        function k(e2, t2, r2) {
          ...
          if (null != t2)
            for (n2 in void 0 !== t2.ref && (a2 = t2.ref), void 0 !== t2.key && (i2 = "" + t2.key), t2)
              S.call(t2, n2) && !T.hasOwnProperty(n2) && (o2[n2] = t2[n2]);
          var c2 = arguments.length - 2;
          if (1 === c2)
            o2.children = r2;
          else if (1 < c2) {
            for (var s2 = Array(c2), l2 = 0; l2 < c2; l2++)
              s2[l2] = arguments[l2 + 2];
            o2.children = s2;
          }
          if (e2 && e2.defaultProps)
            for (n2 in c2 = e2.defaultProps)
              void 0 === o2[n2] && (o2[n2] = c2[n2]);
        ...
        function D(e2, t2, r2) {
          return null == e2 ? 0 : function e3(t3, r3, n2, o2) {
            ...
            if (c2)
              return n2(o2, t3, "" === r3 ? "." + M(t3, 0) : r3), 1;
            if (c2 = 0, r3 = "" === r3 ? "." : r3 + ":", Array.isArray(t3))
              for (var s2 = 0; s2 < t3.length; s2++) {
                var l2 = r3 + M(a2 = t3[s2], s2);
                c2 += e3(a2, l2, n2, o2);
              }
            else if (l2 = null === t3 || "object" != typeof t3 ? null : "function" == typeof (l2 = b && t3[b] || t3["@@iterator"]) ? l2 : null, "function" == typeof l2)
              for (t3 = l2.call(t3), s2 = 0; !(a2 = t3.next()).done; )
                c2 += e3(a2 = a2.value, l2 = r3 + M(a2, s2++), n2, o2);
            else if ("object" === a2)
              throw n2 = "" + t3, Error(m(31, "[object Object]" === n2 ? "object with keys {" + Object.keys(t3).join(", ") + "}" : n2, ""));
            return c2;
          }(e2, "", t2, r2);
        }
        function M(e2, t2) {
        ...
        t.Children = { map: function(e2, t2, r2) {
          ...
          if (null != t2) {
            if (void 0 !== t2.ref && (a2 = t2.ref, c2 = w.current), void 0 !== t2.key && (i2 = "" + t2.key), e2.type && e2.type.defaultProps)
              var s2 = e2.type.defaultProps;
            for (l2 in t2)
              S.call(t2, l2) && !T.hasOwnProperty(l2) && (o2[l2] = void 0 === t2[l2] && void 0 !== s2 ? s2[l2] : t2[l2]);
          }
        ...
        e.exports = function() {
          ...
          for (var r2, i, a = function(e3) {
            ...
            for (var s in r2 = Object(arguments[c]))
              o.call(r2, s) && (a[s] = r2[s]);
            if (n) {
              i = n(r2);
              for (var l = 0; l < i.length; l++)
                u.call(r2, i[l]) && (a[i[l]] = r2[i[l]]);
            }
          }
          return a;
        };
...
// dep:react-typing-effect
var react_typing_effect_default = require_dist();
export {
  react_typing_effect_default as default
};
/*
object-assign
(c) Sindre Sorhus
