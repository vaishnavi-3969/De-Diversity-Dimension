            ...
            {teamMembers.map((member, index) => (
              <div className="bg-gray-800 shadow-md p-6 rounded-lg" key={index}>
                <img
                  src={member.avatar}
                  alt={member.name}
                  className="w-24 h-24 rounded-full mx-auto mb-4 hover:scale-105  hover:shadow-lg hover:bg-gray-600 animate-fadeIn"
                />
                ...
                <div className="flex justify-center space-x-4 ">
                  ...
                  >
                    <FaGithub className="w-6 h-6 text-gray-300 hover:text-gray-100 transition-opacity hover:scale-105" />
                  </a>
                  <a
                    ...
                    rel="noopener noreferrer "
                  >
                    <FaLinkedinIn className="w-6 h-6 text-gray-300 hover:text-gray-100 transition-opacity hover:scale-105" />
                  </a>
                </div>
              </div>
            ))}
